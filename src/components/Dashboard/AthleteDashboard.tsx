...
import { Activity, Calendar, Target, TrendingUp, Clock, Play, CheckCircle, Zap, Trophy } from 'lucide-react';
...
const AthleteDashboard: React.FC = () => {
  ...
  const recentWorkouts = [
    { id: '1', title: 'Tempo Run', distance: 6.2, duration: 28, rating: 4, date: 'Yesterday' },
    { id: '2', title: 'Long Run', distance: 12.1, duration: 72, rating: 5, date: '2 days ago' },
    { id: '3', title: 'Speed Intervals', distance: 5.0, duration: 25, rating: 3, date: '3 days ago' },
  ];
    ...
    <div className="space-y-8">
      <div className="bg-gradient-to-r from-orange-500 via-red-500 to-pink-600 p-8 rounded-3xl text-white shadow-2xl">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold mb-2">Welcome back, {athlete?.name}! 🏃‍♂️</h1>
            <p className="text-orange-100 text-lg">Ready to crush your training goals today?</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-gradient-to-br from-blue-500 to-blue-600 p-6 rounded-2xl text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-blue-100 text-sm font-medium mb-1">Weekly Distance</p>
        ...
        <div className="bg-gradient-to-br from-orange-500 to-red-600 p-6 rounded-2xl text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-orange-100 text-sm font-medium mb-1">Upcoming</p>
        ...
        <div className="p-8">
          <div className="space-y-4">
            {todayWorkouts.map((workout) => (
              <div key={workout.id} className="flex items-center justify-between p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl hover:from-blue-100 hover:to-purple-100 transition-all duration-300 shadow-sm hover:shadow-md">
        ...
        <div className="p-8">
          <div className="space-y-4">
            {recentWorkouts.map((workout) => (
              <div key={workout.id} className="flex items-center justify-between p-6 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl hover:from-green-100 hover:to-emerald-100 transition-all duration-300 shadow-sm hover:shadow-md">
                <div className="flex items-center space-x-4">
                  ...
                  {[...Array(5)].map((_, i) => (
                    <div
                      ...
                      className={`w-4 h-4 rounded-full transition-all duration-200 ${
                        i < workout.rating ? 'bg-gradient-to-r from-yellow-400 to-orange-500 shadow-sm' : 'bg-gray-200'
                      }`}
                    />
                  ))}
                </div>
      ...
      <div className="bg-gradient-to-r from-green-500 to-emerald-600 p-8 rounded-3xl text-white shadow-2xl">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-green-100 text-lg">You're 85% towards your 30-mile weekly target</p>
          </div>
          <div className="text-right">
            <p className="text-3xl font-bold mb-3">25.4 / 30 mi</p>
            <div className="w-40 bg-green-400/30 rounded-full h-3 backdrop-blur-sm">
              <div className="bg-white h-3 rounded-full shadow-sm transition-all duration-500" style={{ width: '85%' }}></div>
            </div>
          </div>
        </div>
      </div>
