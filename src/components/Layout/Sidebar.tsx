...
const Sidebar: React.FC<SidebarProps> = ({ activeTab, onTabChange, isOpen, onClose }) => {
  ...
  const coachNavItems = [
    ...
    { id: 'athletes', label: 'My Athletes', icon: Users, gradient: 'from-green-500 to-emerald-600' },
    { id: 'workouts', label: 'Workouts', icon: Activity, gradient: 'from-orange-500 to-red-600' },
    { id: 'schedule', label: 'Schedule', icon: Calendar, gradient: 'from-purple-500 to-pink-600' },
    { id: 'library', label: 'Exercise Library', icon: BookOpen, gradient: 'from-indigo-500 to-blue-600' },
    { id: 'analytics', label: 'Analytics', icon: BarChart3, gradient: 'from-teal-500 to-cyan-600' },
    { id: 'settings', label: 'Settings', icon: Settings, gradient: 'from-gray-500 to-slate-600' },
  ];

  const athleteNavItems = [
    { id: 'dashboard', label: 'Dashboard', icon: Home, gradient: 'from-blue-500 to-purple-600' },
    { id: 'workouts', label: 'My Workouts', icon: Activity, gradient: 'from-orange-500 to-red-600' },
    { id: 'schedule', label: 'Schedule', icon: Calendar, gradient: 'from-purple-500 to-pink-600' },
    { id: 'progress', label: 'Progress', icon: BarChart3, gradient: 'from-teal-500 to-cyan-600' },
    { id: 'goals', label: 'Goals', icon: Target, gradient: 'from-green-500 to-emerald-600' },
    { id: 'connect', label: 'Find Coach', icon: UserPlus, gradient: 'from-yellow-500 to-orange-600' },
    { id: 'settings', label: 'Settings', icon: Settings, gradient: 'from-gray-500 to-slate-600' },
  ];
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm">
            <div className="text-center">
              <p className="text-xs text-gray-500 font-medium">RunConnect v1.0</p>
            </div>
          </div>
        </div>
      </aside>
